#!/usr/bin/env python3
"""
Simple test for the SITL-only freefall simulator in vtol_proximity_guidance.
"""
...
from vtol_proximity_guidance import simulated_target_response_after_event, VehicleState
