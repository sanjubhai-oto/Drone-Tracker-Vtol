#!/usr/bin/env python3
"""Generate a static 3D-style trajectory SVG from mothdrone telemetry."""
...
OUT = ROOT / "outputs" / "graphs" / "mothdrone_trajectory_3d.svg"
...
def main() -> None:
    ...
    parts = [
        ...
        text(34, 48, "Mothdrone VTOL 3D Trajectory", 30),
